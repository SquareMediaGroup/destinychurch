  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        role: "site_admin",
        description:
          "Which links, QR codes and tiles people actually use — and how the whole site is doing.",
        keywords: [
          "stats",
          "statistics",
          "traffic",
      ...
      },
      {
        ...
        icon: "history",
        role: "super_admin",
        description: "Everything anyone has done in the admin — ask it, or read the detail.",
        keywords: [
          "log",
          "history",
          "who",
