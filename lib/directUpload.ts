// Browser-side half of the direct-upload flow — PUTs bytes straight to
// Playbook's storage (GCS or Backblaze) using the signed destination(s) from a
// prepare route. Runs entirely client-side: fetch/XHR here
