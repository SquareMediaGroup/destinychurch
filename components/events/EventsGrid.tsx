      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-center">
          <div className="flex flex-1 items-center gap-3 rounded-2xl border border-black/8 bg-gray-50 px-4 py-3 shadow-sm transition-shadow focus-within:border-destiny-orange/30 focus-within:shadow-md">
            <svg className="h-4 w-4 shrink-0 text-subtle" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <button
                ...
                className={`rounded-xl px-4 py-2 text-sm font-semibold transition ${
                  mode === option.value
                    ...
                    : "text-subtle hover:text-destiny-grey"
                }`}
              >
                {option.label}
              </button>
              ...
              {filtered.map((group, groupIndex) => (
                <div key={group.key}>
                  ...
                  <h2
                    ...
                    className="sticky top-[72px] z-[5] -mx-1 mb-5 bg-white/85 px-1 py-2 text-[13px] font-bold uppercase tracking-[0.14em] text-subtle backdrop-blur"
                  >
                    {group.label}
                  </h2>
