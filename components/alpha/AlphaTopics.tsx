          ...
          <AnimateIn delay={100} className="w-full md:w-1/2">
            <div className="grid grid-cols-2 gap-3">
              <div className="overflow-hidden rounded-2xl">
                <img src="/img/Alpha/Alpha/WiA-SC_V2-Carousel_02.jpg" alt="" className="w-full object-cover h-48" />
              </div>
              <div className="overflow-hidden rounded-2xl">
                <img src="/img/Alpha/Alpha/WiA-SC_V2-Carousel_03.jpg" alt="" className="w-full object-cover h-48" />
              </div>
              <div className="col-span-2 overflow-hidden rounded-2xl">
                <img src="/img/Alpha/Alpha/WiA-SC_V2-Carousel_04.jpg" alt="" className="w-full object-cover h-40" />
              </div>
            </div>
          </AnimateIn>
        </div>
