...
export type ElementMeta = {
  ...
  category: "Primitive" | "Layout" | "Brand";
  description: string;
};

// Component palette registry — what shows up in the toolbar
export const ELEMENT_REGISTRY: ElementMeta[] = [
  ...
  { type: "WhatsOnSection", label: "What's On", icon: "event", category: "Brand", description: "Upcoming events list" },
  ...
  { type: "LatestSermonSection", label: "Latest Sermon", icon: "play_circle", category: "Brand", description: "Most recent sermon" },
...
export const CATEGORIES: Array<ElementMeta["category"]> = ["Primitive", "Layout", "Brand"];
