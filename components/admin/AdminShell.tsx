...
// The /admin chrome. app/admin/layout.tsx is a server wrapper around this so
// the segment can declare itself dynamic, which a "use client" layout cannot.
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  // The standalone auth pages take over the full viewport — no sidebar
