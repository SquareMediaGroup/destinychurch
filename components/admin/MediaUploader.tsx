            ...
            >
              <div className="flex gap-4 items-start mb-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1 text-xs font-semibold text-destiny-orange mb-1">
                    <span className="material-symbols-rounded text-sm">
                      {item.mediaType === "image" ? "image" : "videocam"}
                    </span>
                ...
                <div className="space-y-3 bg-destiny-orange/5 -mx-4 -mb-4 p-4 rounded-b-lg">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="E.g., Church building exterior, Pastor at pulpit, Group of volunteers"
                      rows={2}
