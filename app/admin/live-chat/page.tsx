          ...
          <button
            ...
            className={`inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-bold transition ${
              tab === t.id
                ...
                : "bg-white text-destiny-grey/60 hover:text-destiny-grey"
            }`}
          >
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-black/10 bg-white px-4 py-2.5 text-sm font-bold text-destiny-grey/70 transition hover:bg-[#f5f7fa] disabled:opacity-60"
            >
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="rounded-xl border border-black/10 bg-white px-3 py-2 text-xs font-bold text-destiny-grey/70 transition hover:bg-[#f5f7fa] disabled:opacity-60"
                  >
                    Bin it
                  </button>
                </div>
            ...
            {blocks.map((b) => (
              ...
              >
                ...
                <button
                  ...
                  className="rounded-xl border border-black/10 bg-white px-3 py-2 text-xs font-bold text-destiny-grey/70 transition hover:bg-white disabled:opacity-60"
                >
                  Unmute
                </button>
              </li>
                  ...
                  {r.status === "praying" && (
                    <>
                      ...
                      <button
                        ...
                        className="rounded-xl border border-black/10 bg-white px-3 py-2 text-xs font-bold text-destiny-grey/60 transition disabled:opacity-60"
                      >
                        Put back
                      </button>
                    </>
