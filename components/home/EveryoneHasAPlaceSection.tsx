  ...
  return (
    <div className="relative group">
      ...
      <button
        ...
        className="absolute top-4 right-4 z-50 rounded-md bg-black/70 px-3 py-1.5 text-xs font-medium text-white opacity-0 transition-opacity hover:bg-black group-hover:opacity-100 sm:top-8 sm:right-8"
